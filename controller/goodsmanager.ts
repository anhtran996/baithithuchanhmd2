...
export class GoodsManager {
    ...
    findbyName() {
        while (true) {
            let name = readlineSync.question("Enter name of item you want to find?: ")
    ...
    addGoods(): void {
        ...
        let item = new Goods(id, name, type, price, quantity, addDay, description)
